...
class Args(object):  # 创建Circle类
    def __init__(self):  # 约定成俗这里应该使用r，它与self.r中的r同名
        ...
        self.test_data_dir = 'C://aster.pytorch-master//data//Case-Sensitive-Scene-Text-Recognition-Datasets-master//svt_test//'
        self.logs_dir = 'C://aster.pytorch-master//data'
        self.real_logs_dir = 'C://aster.pytorch-master//data'
